...
import { handleAddDoctorDetails, handleGetDoctorDetails, handleUpdateDoctorDetails, handleAddPatientByEmail, getMyPatients } from "../controllers/doctorController.js";
...
router.route("/get-my-patients").get(authMiddleware([ROLES.DOCTOR]), getMyPatients);
